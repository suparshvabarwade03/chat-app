...
function ChatContainer() {
    ...
    const handleSendImage = async (e) => {
        ...
        reader.onloadend = async () => { 
            ...
            e.target.value = ""         // clear after use 
        }
    ...
    useEffect(() => {
        if (scrollEnd.current && messages) {
            scrollEnd.current.scrollIntoView({ behavior: "smooth" })      // ref={scrollEnd} chya div paryant scroll hotai 
        }
    }, [messages])
        ...
        <div className='h-full overflow-scroll relative backdrop-blur-lg'>
            ...
            <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
                <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full">
                    ...
                    <input onChange={handleSendImage} type="file" id='image' accept='image/png , image/jpeg' hidden />           {/* gallery open hotai  */}
                    <label htmlFor='image'>
